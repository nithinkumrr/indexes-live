      ...
      <div className="spc-dhead">
        <div style={{flex:1,minWidth:0}}>
          <div style={{display:'flex',alignItems:'center',gap:8,marginBottom:4}}>
            ...
            <span style={{fontSize:9,fontWeight:700,letterSpacing:1,color:'var(--text3)',background:'rgba(255,255,255,0.06)',borderRadius:4,padding:'2px 6px',whiteSpace:'nowrap'}}>
              {['BEGINNER','MODERATE','ADVANCED','EXPERT','EXPERT'][strat.complexity-1]}
            </span>
          </div>
          <div className="spc-dhook">{strat.hook}</div>
        </div>
        <div className="spc-dscore" style={{borderColor:scoreC+'40',background:scoreC+'0D',flexShrink:0}}>
      ...
      <div className="spc-two-col">
        ...
        <div className="spc-inputs-col">
          ...
          <div className="spc-edu" style={{marginTop:'auto',paddingTop:10}}>
            <div className="spc-edu-block" style={{background:'rgba(0,200,150,0.05)',border:'1px solid rgba(0,200,150,0.15)',borderRadius:8,padding:'10px 12px'}}>
              <div className="spc-edu-h" style={{color:'#00C896',marginBottom:4}}>✓ WHY IT WORKS</div>
              <div className="spc-edu-t">{strat.why}</div>
            </div>
            <div className="spc-edu-block spc-edu-danger" style={{background:'rgba(255,68,85,0.05)',border:'1px solid rgba(255,68,85,0.18)',borderRadius:8,padding:'10px 12px'}}>
              <div className="spc-edu-h" style={{color:'#FF4455',marginBottom:4}}>⚠ WHAT KILLS IT</div>
                  ...
                  return (
                    <div key={s.id} className={`spc-item ${selId===s.id?'spc-item-on':''}`} onClick={() => setSelId(s.id)}>
                      ...
                      <div className="spc-item-r2">
                        <span style={{color:g.color,fontSize:10,fontWeight:600,textTransform:'uppercase',letterSpacing:1}}>{g.label}</span>
                        <span style={{color:s.credit?'#00C896':'#FF4455',fontSize:10,fontWeight:600}}>{s.credit?'COLLECT':'PAY'}</span>
                        <span style={{color:'var(--text3)',fontSize:9,letterSpacing:1}}>{'●'.repeat(s.complexity)}{'○'.repeat(4-s.complexity)}</span>
                      </div>
                    </div>
                  );
                })}
