...
function SipCalc({ nav }) {
  ...
  return (<>
    <div className="ch-sip-layout">
      ...
      {/* ── LEFT 60%: Inputs ───────────────────────────────────────────── */}
      <div className="ch-sip-inputs-col">
        ...
        <div style={{ marginTop:'auto', paddingTop:20, borderTop:'1px solid var(--border)', marginTop:'auto' }}>
          <div style={{ fontSize:9, fontWeight:700, letterSpacing:'0.1em', color:'var(--text3)',
            textTransform:'uppercase', marginBottom:8 }}>Related calculators</div>
      ...
      {open && (
        <div style={{ position:'absolute', top:'100%', left:-16, right:-16, zIndex:200,
          ...
          <div style={{ padding:'10px 12px 6px', borderTop:'1px solid var(--border)' }}>
            <button
              onClick={() => { (navigateTo ? navigateTo('calc') : navigateSub && navigateSub('/calc', 'Risk Calculator | indexes.live')); setOpen(false); }}
  ...
  return (
    <div className="ch-outer-grid" style={{ padding:'0 20px 40px', display:'grid',
      ...
      <div className="ch-sidebar" style={{ position:'sticky', top:60, paddingTop:24 }}>
        ...
        <button onClick={() => (navigateTo ? navigateTo('calc') : navigateSub && navigateSub('/calc', 'Risk Calculator | indexes.live'))}
