...
export const MARKETS = [
  ...
  { id: 'giftnifty', symbol: 'NIFTY_GIFT', flag: '🇮🇳', country: 'India',          exchange: 'NSE IFSC',      name: 'Gift Nifty',      tz: 'Asia/Kolkata',        open: [6,30],  close: [23,30], region: 'Asia',      category: 'index',     fallback: { price: 22480, prevClose: 23100 }, simulation: true, note: 'Pre-market signal', giftCard: true },
  ...
  { id: 'adx',       symbol: '^FTFADGI',   flag: '🇦🇪', country: 'UAE — Abu Dhabi',exchange: 'ADX',           name: 'ADX General',     tz: 'Asia/Dubai',          open: [10,0],  close: [14,45], region: 'MEA',       category: 'index',     fallback: { price: 9380,  prevClose: 9350  } },
  ...
  { id: 'ngx',       symbol: '^NGSE',      flag: '🇳🇬', country: 'Nigeria',        exchange: 'NGX',           name: 'NGX All Share',   tz: 'Africa/Lagos',        open: [10,0],  close: [14,30], region: 'MEA',       category: 'index',     fallback: { price: 104500,prevClose: 103800} },
  { id: 'qse',       symbol: '^QSI',       flag: '🇶🇦', country: 'Qatar',          exchange: 'QSE',           name: 'QE All Share',    tz: 'Asia/Qatar',          open: [9,0],   close: [13,15], region: 'MEA',       category: 'index',     fallback: { price: 10350, prevClose: 10280 } },
  { id: 'kwse',      symbol: '^KWSE',      flag: '🇰🇼', country: 'Kuwait',         exchange: 'Boursa',        name: 'Kuwait All Share', tz: 'Asia/Kuwait',        open: [9,30],  close: [12,30], region: 'MEA',       category: 'index',     fallback: { price: 7820,  prevClose: 7795  } },
  ...
  { id: 'masi',      symbol: '^MASI.CA',   flag: '🇲🇦', country: 'Morocco',        exchange: 'CSE',           name: 'MASI',            tz: 'Africa/Casablanca',   open: [9,30],  close: [15,30], region: 'MEA',       category: 'index',     fallback: { price: 14820, prevClose: 14760 } },
