...
function getTodayInfo() {
  ...
  if (isMarketHoliday) {
    ...
    riskLevel = 'EXTREME'; action = 'Monthly expiry. Gamma and volatility elevated in final hour.';
    subAction = 'Options premiums decay sharply into expiry close.';
    expiryNote = 'Nifty Monthly Expiry today';
  } else if (isExpiryToday) {
    riskLevel = 'HIGH'; action = 'Expiry day. Elevated gamma risk in final 90 minutes.';
...
function TodayPlaybook() {
  ...
  if (t.isMarketHoliday) {
    ...
    marketType = 'Monthly Expiry Day'; strategy = 'High gamma risk. Premium decay accelerates near close.';
