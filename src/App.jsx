...
const SUB_PATH = {
  ...
  '/brokers-review':      { view: 'brokers', tab: 'Rankings'    },
  '/brokers-review/rankings':  { view: 'brokers', tab: 'Rankings'    },
  '/brokers-review/compare':   { view: 'brokers', tab: 'Direct Comparison' },
  '/brokers-review/charges':   { view: 'brokers', tab: 'Charges Guide' },
  '/brokers-review/calculator':{ view: 'brokers', tab: 'Brokerage Calc' },
  ...
  '/risk-calculator':   { view: 'calc', tab: 'start'       },
...
const PATH_MAP = {
  ...
  '/ipo':        'ipo',
  '/calc':       'calc',
  '/risk-calculator': 'calc',
  '/calculators':'calculators',
  '/insights':   'insights',
  '/brokers':         'brokers',
  '/brokers-review':  'brokers',
  '/blog':       'insights',
  '/mtf':        'mtf',
  '/delivery':   'delivery',
};
...
export default function App() {
  ...
  const META_DESCS = {
    ...
    '/brokers-review':      'Every Indian broker charge calculated and compared. Zerodha vs Dhan vs Groww vs Angel One. Find the broker that keeps more money in your pocket.',
    '/brokers-review/rankings':    'Indian brokers ranked by total cost on a 50K delivery trade. All charges included: brokerage, DP, AMC and government fees. No guesswork.',
    '/brokers-review/compare':     'Compare any two Indian brokers head to head. Per-trade cost, annual cost by profile and all charges. Pick the one that actually costs less.',
    '/brokers-review/charges':     'Complete guide to Indian broker charges. Delivery, intraday, F&O, DP, AMC, MTF and settlement fees all explained. Know every rupee you pay.',
    '/brokers-review/calculator':  'Calculate the exact brokerage and charges for any trade across 15+ Indian brokers. Enter your trade size. See the real cost instantly.',
    '/risk-calculator':     'Stop guessing your risk. Position sizing, stop loss distance, risk reward ratio and drawdown recovery. Built for traders who trade with discipline.',
