...
function getSlotInfo() {
  ...
  const slots = [
    { name: 'premarket', label: 'Pre-Market',         window: 'Before 9:15 AM',        context: 'NSE market has not yet opened. IMPORTANT: there is no pre-market session for Nifty — use GIFT Nifty futures as the indicator of where Nifty may open. Cover: GIFT Nifty level and implied gap, overnight US markets (S&P 500, Nasdaq), Asian markets (Nikkei, Hang Seng), crude oil, gold, USD/INR, and what sectors to watch at open. Do NOT mention Nifty price changes as the market is not open.',           minStart: 0,   minEnd: 554,  ttl: 3600  },
    { name: 'open15',    label: '9:15 AM Opening',    window: '9:15 AM to 9:30 AM',    context: 'First 15 minutes of trade. The opening. Cover: how Nifty has opened vs GIFT Nifty implied, whether it is a gap up or gap down, early trend, volume at open, whether the opening gap is holding or fading. This is too early to call the day — just report what has happened in the first 15 minutes.',                       minStart: 555,  minEnd: 569,  ttl: 900   },
    { name: 'opening',   label: 'Morning Session',    window: '9:30 AM to 10:30 AM',   context: 'First hour of trade is complete or in progress. Cover: what has happened since the open, whether the opening direction is holding, early momentum, key levels being tested, and any news driving the move. Do not project the rest of the day — report what has actually happened so far.',                                       minStart: 570,  minEnd: 629,  ttl: 3600  },
    { name: 'midmorn',   label: 'Mid-Morning',        window: '10:30 AM to 12:00 PM',  context: 'Morning trend is now established. Cover: whether the morning trend is holding or reversing, volume patterns, which sectors are leading or lagging, and what levels matter for the rest of the day. Be specific about what Nifty has done so far today.',                                                                            minStart: 630,  minEnd: 719,  ttl: 3600  },
    { name: 'midday',    label: 'Mid-Day Update',     window: '12:00 PM to 1:00 PM',   context: 'Noon update. Cover: morning summary, current trend, volume, and what to watch in the second half. Mid-day often sees reduced participation — note if that is the case.',                                                                                                                                                           minStart: 720,  minEnd: 779,  ttl: 3600  },
    { name: 'afternoon', label: 'Afternoon Session',  window: '1:00 PM to 2:00 PM',    context: 'Post-lunch session. Cover: whether the morning trend has continued or reversed, key levels, and institutional activity. Note any sector rotation or expiry-related positioning.',                                                                                                                                                     minStart: 780,  minEnd: 839,  ttl: 3600  },
    { name: 'latesess',  label: 'Late Session',       window: '2:00 PM to 3:00 PM',    context: 'Final hour of serious trading. Cover: current day trend, key support/resistance being tested, institutional positioning into the close. This is when smart money shows its hand.',                                                                                                                                                   minStart: 840,  minEnd: 899,  ttl: 3600  },
    { name: 'closing',   label: 'Closing Phase',      window: '3:00 PM to 3:30 PM',    context: 'Final 30 minutes. NSE closes at 3:30 PM sharp — there is NO post-market trading session in India. Cover: where Nifty is heading into close, whether there is any last-minute buying or selling, likely closing level.',                                                                                                              minStart: 900,  minEnd: 929,  ttl: 2700  },
    { name: 'close',     label: 'End of Day Wrap',    window: '3:30 PM to 5:00 PM',    context: 'Market is now closed for the day at 3:30 PM IST. NSE does not have any post-market session. Write a comprehensive day summary: how did Nifty and Bank Nifty play out through the full session, what were the key turning points, what drove the move, closing levels, and FII/DII data if available.',                            minStart: 930,  minEnd: 1019, ttl: 5400  },
    { name: 'evening',   label: 'Evening Report',     window: 'After 5:00 PM',         context: 'Evening wrap after FII/DII data is published. Write a full day debrief: what happened through the entire session, FII/DII final numbers, what drove markets, key levels that held or broke, and setup points to watch for the next trading session. This is the final update for the day.',                                          minStart: 1020, minEnd: 9999, ttl: 43200 },
  ];
  ...
  if (day === 0 || day === 6) {
    ...
    return { name: 'eod', label: 'End of Week Wrap', window: 'Week wrap', context: 'Markets are closed for the weekend. Cover the full week that was: key drivers, sector performance, FII/DII trend, commodity moves, and the global and domestic setup for the coming week. This should read as a proper end-of-week debrief that a trader or investor can act on when markets reopen.', key: `${fridayStr}-eod`, ttl: 172800, isWeekend: true };
  }
